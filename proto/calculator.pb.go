...
const file_proto_calculator_proto_rawDesc = "" +
	...
	"\x03Sum\x12\v.AddRequest\x1a\f.AddResponseB\tZ\a./protob\x06proto3"
...
var file_proto_calculator_proto_depIdxs = []int32{
	0, // 0: CalculatorService.Sum:input_type -> AddRequest
	1, // 1: CalculatorService.Sum:output_type -> AddResponse
